	...
	"structured": {
		"normal": [
			...
			},
			{
				...
				route_change: {
					tag: ['A-operates-then-overC'],
					message: "[M] service operates between Broadway Junction and Essex St, and is rerouted via the [J] to/from Chambers St.",
					trains: ['M'],
					route: [
						{
							lines: ["M"],
			...
			},
			{
				...
				route_change: {
					...
					message_mod: "Some southbound [2] and [3] trains end at [Mn327-137] Some southbound [2] and [3] trains are stopping along the [1] line from [Mn327-137] to [Mn635-142] then end. Southbound [4] and [5] trains end at [Mn414-420]",
					trains: ['2','3'],
					route: [
						{
							lines: ["2","3"],
...
*/
			...
			},
			{
				...
				tag: ["MTAD-006", "MTAD-001", "MTAD-011", "MTAD-014"],
				time: null,
				...
				route_change: {
					...
					message: "[F] service operates b etween [Qs254-F01] and [Mn223-B08], and via the [Q] to/from [Bk617-235] (skipping [Bk26-R30], days and evenings), and via the [D] to/from [Bk58-D43] . Trains trains are rerouted via the [A] in Manhattan along",
					trains: ['F'],
					route: [
						{
							lines: ['F'],
...

			{
				...
				tag: ["MTAD-001", "MTAD-012", "MTAD-011", "MTAD-014"],
				time: null,
				durration: "Weekends, 9:30 PM Fri to 5 AM Mon, Jan 5 - 8 Jan 12 - 15",
