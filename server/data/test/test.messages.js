		...
		"normal": [
			...
			},
			{
				...
				route_change: {
					...
					message: "[M] service operates between [Bk621-J27] and [Mn625-M18], and is rerouted via the [J] to/from [Mn622-M21]. ``` [M] service operates in two sections: 1. Between [Mn625-M18] and [Bk97-M11], and via the [J] to/from [Bk621-J27], days/evenings*. 2. Between Metropolitan Av and Myrtle-Wyckoff Avs",
					trains: ['M'],
					route: [
						{
							lines: ["M"],
...
*/
			...
			},
			{
				...
				route_change: {
					...
					message: "[E] trains are rerouted in both directions via the [F] between [Qs616-G14] and [Mn167-A32] ``` [E] trains run local between [Qs261-G08] and [Qs221-B04]",
					trains: ["E"],
					route: [
						{
							lines: ['E'],
			...
			},
      {
        ...
        route_change: {
          ...
          message: "[4] Service operates in two sections: 1. Between [Bx378-401] and [Mn392-621] 2. Between [Mn392-621] and [Bk352-257]",
          trains: ['4'],
          route: [
            {
              allTrains: true,
          ...
          route: [
			...
			},
			{
				...
				route_change: {
					...
					message: "[F] service operates b etween [Qs254-F01] and [Mn223-B08], and via the [Q] to/from [Bk617-235] (skipping [Bk26-R30], days and evenings), and via the [D] to/from [Bk58-D43] . Trains run express in Manhattan ``` trains are rerouted via the [A] in Manhattan",
					trains: ['F'],
					route: [
						{
							lines: ['F'],
			...
			},
			{
				...
				tag: ["MTAD-001", "MTAD-002", "MTAD-004", "MTAD-010", "MTAD-013"],
				time: null,
